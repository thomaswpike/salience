function filter = makegaborfilters(angle,phase,stddev,elongation,filterSize,filterPeriod,makeDisc)
...
gaborParams.stddev = stddev;
gaborParams.elongation = elongation;
gaborParams.filterSize = filterSize;
gaborParams.filterPeriod = filterPeriod;
